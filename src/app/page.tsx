          ...
          <div className="flex flex-col gap-[42px]">
            ...
            <div className="w-[534px]">
              <div className="relative flex flex-col gap-[11px]">
                <button
                  onClick={openModal}
                  className="py-[18px] px-[150px] bg-white text-black text-[22px] leading-[1.7] font-medium rounded-full"
                >
                  {lang.value === 'ua'
                    ? 'Придбати зі знижкою'
                    : 'Buy with discount'}
          ...
          <ul className="flex flex-wrap gap-[20px] mt-[79px] justify-center">
            <li className="max-w-[360px]">
              <div className="pr-[37px] pl-[37px] pt-[36px] pb-[26px] bg-gradient-to-b  rounded-[18px]   from-[rgba(167,93,243,0.2)] via-[rgba(12,1,23,1)] to-[rgba(167,93,243,0.2)]">
                ...
                <button
                  onClick={openModal}
                  className="font-manrope font-semibold mt-[160.5px] text-[16px] tracking-[0%] py-[17.5px] px-[115.5px] bg-white text-[rgba(12,1,23,1)] rounded-[50px]"
                >
            ...
            <li className="max-w-[360px] ">
              <div className="min-h-[466px] bg-white px-[37px] py-[20px] rounded-[18px]">
                ...
                <button
                  onClick={openModal}
                  className="font-manrope font-semibold mt-[35px] text-[16px] tracking-[0%] py-[17.5px] px-[115.5px] bg-[rgba(12,1,23,1)] text-white rounded-[50px]"
                >
                  {lang.value === 'ua' ? 'КУПИТИ' : 'BUY'}
                </button>
              </div>
            ...
            <li className="max-w-[360px] min-h-[466px]">
              <div className=" min-h-[466px] rounded-[18px] px-[37px] py-[25px] bg-[linear-gradient(180deg,rgba(91,219,253,1),rgba(115,117,255,1),rgba(167,93,243,0.2))]">
                ...
                <button
                  onClick={openModal}
                  className="font-manrope font-semibold mt-[27px] text-[16px] tracking-[0%] py-[17.5px] px-[115.5px] bg-white text-[rgba(12,1,23,1)] rounded-[50px]"
                >
                  {lang.value === 'ua' ? 'КУПИТИ' : 'BUY'}
                </button>
              </div>
