      ...
      <div className="absolute right-[32%] top-[10%] w-[534px] text-center flex flex-col justify-center items-center">
        <div className='max-w-[447px]'>
          <h2 className="text-[36px] font-semibold mb-[20px] w-[447px] uppercase">
            Дізнайся як створити контент, який <span className='text-[32px] font-semibold bg-[linear-gradient(90.63deg,#90E8FF_0.44%,#9C9EFF_69.99%,#E3A1FF_138.27%,#E56F8C_173.01%)] bg-clip-text text-transparent'>підкорює аудиторію</span> 
          </h2>
        ...
        <div className="relative flex flex-col gap-[11px]">
          <button className="py-[18px] px-[150px] bg-[linear-gradient(126.34deg,#5BDBFD_16.95%,#7375FF_79.54%,#DF93FF_140.99%,#E56F8C_172.25%)] text-white text-[22px] leading-[1.7] font-medium rounded-full">
